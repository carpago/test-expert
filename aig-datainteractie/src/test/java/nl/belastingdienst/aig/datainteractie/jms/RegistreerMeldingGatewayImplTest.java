...
import nl.belastingdienst.aig.jms.RegistreerMeldingGatewayJMSImpl;
...
public class RegistreerMeldingGatewayImplTest extends TestCase {

	private JmsTemplate template;
	private RegistreerMeldingGatewayJMSImpl registreerMeldingGateway;
	...
	public RegistreerMeldingGatewayImplTest() {
// DateFormat df = DateFormat.getDateInstance();
	...
	@Before
	public void setUp() {
		this.registreerMeldingGateway = new RegistreerMeldingGatewayJMSImpl();
		this.template = EasyMock.createMock(JmsTemplate.class);
		this.registreerMeldingGateway.setJmsTemplate(this.template);
	}
	...
	public void testRegistreerMelding() throws Exception {
		...
		this.template.convertAndSend(expectedArgumentToGateway);
		EasyMock.replay(this.template);
