package nl.belastingdienst.aig.dao.data;
...
/**
 * @generated
 * Generated Class: CtgDFHMIRSOutput
 * @type-descriptor.aggregate-instance-td accessor="readWrite" contentSize="4096" offset="0" size="4096"
 * @type-descriptor.platform-compiler-info language="COBOL" defaultBigEndian="true" defaultCodepage="ibm-1140" defaultExternalDecimalSign="ebcdic" defaultFloatType="ibm390Hex"
 */

public class CtgDFHMIRSOutput implements javax.resource.cci.Record, javax.resource.cci.Streamable,
		com.ibm.etools.marshall.RecordBytes {
	private static final long serialVersionUID = 7539500249771800547L;
	...
	static {
		...
		String linkage__interfaceInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(linkage__interfaceInitialValue, initializedBuffer_, 0, "ibm-1140",
				4096, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
	}
	 ...
	 * @generated
	 */
	public CtgDFHMIRSOutput(java.util.HashMap valFieldNameMap) {
	...
	public int evaluateFormula(String formula, java.util.HashMap valFieldNameMap) throws IllegalArgumentException {
		...
		if (function.equalsIgnoreCase("val")) {
			...
			result = -1
					* evaluateFormula(formula, valFieldNameMap);
			return (result);
		} else {
	...
	/**
	 * @generated
	 * @type-descriptor.restriction maxLength="4096"
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="4096" offset="0" size="4096"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
	public String getLinkage__interface() {
		String linkage__interface = null;
		linkage__interface = MarshallStringUtils.unmarshallFixedLengthStringFromBuffer(buffer_, 0, "ibm-1140", 4096);
		return (linkage__interface);
	}

	/**
	 * @generated
	 */
	public void setLinkage__interface(String linkage__interface) {
		if (linkage__interface != null) {
			if (linkage__interface.length() > 4096)
				throw new IllegalArgumentException(MarshallResource.instance()
					.getString(MarshallResource.IWAA0124E, linkage__interface, "4096", "linkage__interface"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(linkage__interface, buffer_, 0, "ibm-1140", 4096,
