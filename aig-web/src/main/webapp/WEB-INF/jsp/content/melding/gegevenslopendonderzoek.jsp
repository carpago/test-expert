<fieldset
		...
		<legend align="left"><spring:message code="title.gegevens.lopend.onderzoek" /></legend>
		<table style="border: 0; cellpadding: 4; cellspacing: 3" width="865">
			...
			<tbody>
				<tr>
					<td></td>
					<td style="vertical-align: top" width="148">${onderzoek.datumIngang}</td>
					<td width="99">${onderzoek.medewerker}</td>
					<td width="268">${onderzoek.ketenVanOnderzoek}</td>
				</tr>
			</tbody>
		</table>
	</fieldset>