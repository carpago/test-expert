...
<body>
	<h4>
		<spring:message code="title.beoordelen.melding.parkeren" />
	</h4>
	...
	<tbody>
		<tr>
			<td>
				...
				<form:hidden path="actie" value="parkeren" />
				
				<input type="submit" onclick="annuleren();" name="annuleren" value="Annuleren"
				title="Terug naar raadplegen van de melding"> 
				
				<input type="submit" name="opslaan" value="Parkeren" title="Opslaan melding / Afsluiten beoordeling." />
			</form:form></td>
		</tr>
