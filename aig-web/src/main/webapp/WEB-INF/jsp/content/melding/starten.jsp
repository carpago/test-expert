...
<title><spring:message code="title.beoordelen.melding.bewerken" />
</title>
...
<body>
	<h4>
		<spring:message code="title.beoordelen.melding.starten" />
	</h4>
...
<table border="0">
	<tbody>
		<tr>
			<td>
				...
				<form:hidden path="actie" value="starten" />
				
				<input type="submit" onclick="annuleren();" name="annuleren" value="Annuleren"
				title="Terug naar raadplegen van de melding"> 
				
				<input type="submit" name="opslaan" value="Starten" title="Opslaan melding / Afsluiten beoordeling." />
			</form:form></td>
		</tr>
	...
	<form action="03 Raadplegen melding.html" method="post"
		id="annulerenForm" /></form>
</body>
</html>